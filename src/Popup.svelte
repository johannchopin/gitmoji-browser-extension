...
const getFilteredGitmojis = (searchValue, gitmojis) => {
    ...
    return gitmojis.filter(gitmoji => {
      return gitmoji.description.toLowerCase().includes(loweredSerchValue) 
